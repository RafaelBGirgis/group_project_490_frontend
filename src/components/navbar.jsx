...
export function Navbar({ role = "client", userName = "JD", onMessage, onNotification }) {
  ...
  return (
    <nav className="flex items-center justify-between px-6 py-3 bg-[#0B1120] border-b border-white/5">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="font-semibold text-lg tracking-tight text-white">Till Failure</span>
