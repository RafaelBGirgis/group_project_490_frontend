...
export default function CoachChatPage() {
  ...
  const findPreferredConversation = (convos, partnerId) => {
    const matches = convos.filter((conversation) => String(conversation.partner_id) === String(partnerId));
        ...
        <div className="flex gap-4 h-[calc(100vh-120px)]">
          <div className="w-80 shrink-0 flex flex-col rounded-2xl border border-white/6 bg-[#0F1729]">
            <div className="px-4 py-4 border-b border-white/5">
              <h2 className="text-lg font-bold text-white">Coach Messages</h2>
                ...
                <div className="px-6 py-4 border-t border-white/5">
                  ...
                  >
                    <input
                      ...
                      className="flex-1 rounded-xl border border-white/10 bg-[#0A1020] px-4 py-3 text-sm text-white outline-none transition placeholder:text-gray-600 focus:border-orange-400/40 focus:ring-2 focus:ring-orange-500/10"
                    />
                    <button
                      type="submit"
                      disabled={!draft.trim() || sending}
                      className="px-5 py-3 rounded-xl text-sm font-medium text-white transition bg-orange-600 hover:bg-orange-700 disabled:bg-orange-900/40 disabled:cursor-not-allowed"
                    >
                      {sending ? "..." : "Send"}
                    </button>
                  </form>
